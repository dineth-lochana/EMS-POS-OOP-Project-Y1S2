...
public class employeemailnotification extends JFrame{
    ...
    public employeemailnotification() {
        sendEmailButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String query = "select email from employees_test where empid in (Select empid from employeeorderallocation where `index` = '"+index+"');";
                    ...
                    String name = null;
                    if (resultSet.next()) {
                        myemail = resultSet.getString( "email");
                ...
                //------Sending Mail
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Employee order is not allocated in the database", "Not Found", 0);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                employeemailnotification ui = new employeemailnotification();
